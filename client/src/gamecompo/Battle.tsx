...
import {restoreHP,getAttackFromEnemy,getExp} from "../store/features/userStatuSlice"
...
function Battle({socket}:socketType) {
    ...
    useNonInitialEffect(()=>{
        switch(sceneState){
            case appearedScene: setDialog(appearDialog); break;
            case yourTurnScene: setDialog(yourturnDialog); break;
            case yourActionScene: setDialog(youractionDialog); break;
            case enemiesTurnScene: setDialog(enemyturnDialog); break;
            case afterEnemyActionScene: setDialog(afterEnemyActionDialog); break;
            case afterBattleScene: setDialog(BattleResultDialog); break;
            default: break;
    ...
    return ( 
        ...
        <>
                    ...
                    <button onClick={(e)=>{dispatch(restoreHP({hp:20}))}}>restore</button>
                    <button onClick={(e)=>{dispatch(maketozero1())}}>;alskj</button>
                    <button onClick={(e)=>{dispatch(maketozero2())}}>;alskj</button>
                    <button onClick={(e)=>{dispatch(maketozero3())}}>;alskj</button>
                    <h1>{sceneState}</h1>
                    </motion.div>
